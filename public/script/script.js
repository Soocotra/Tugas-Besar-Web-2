$(document).ready(function () {
    ...
    img[0].onclick = ()=>{
        ...
        bg.style.backgroundImage = "url('../image/anjungan.jpg')"; 
        ...
        $(".wrapper").css({"background-color": "transparent", 'margin':  '20px 90px'});
        bg.style.backgroundImage = "url('../image/ppiptek.JPG')";
        ...
        $(".wrapper").css({"background-color": "transparent", 'margin':  '20px 90px'});
        bg.style.backgroundImage = "url('../image/Jakarta-TMII_1920x1080px-1030x579.jpg')";
        ...
        bg.style.backgroundImage = "url('../image/Taman.jpg')";
